...
public interface RegionCoprocessorEnvironment extends CoprocessorEnvironment<RegionCoprocessor> {
  ...
  /**
   * Returns an RpcQuotaManager that can be used to apply quota checks against the
   * workloads generated by the coprocessor.
   ...
   * todo rmattingly
   */
  OperationQuota checkScanQuota(Scan scan, long maxBlockBytesScanned, long prevBlockBytesScannedDifference) throws IOException;
}

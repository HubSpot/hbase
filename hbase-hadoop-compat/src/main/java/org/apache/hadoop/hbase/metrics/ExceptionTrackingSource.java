...
public interface ExceptionTrackingSource extends BaseSource {
  ...
  String EXCEPTIONS_TYPE_DESC =
    "Number of requests that resulted in the specified type of Exception";
  ...
  String EXCEPTIONS_FILE_NOT_FOUND = "exceptions.fileNotFoundExceptions";
